	...
	//added js
		...
		htmlString ='<p><h1>Beverage Name:'+ result.rows.item(0).beverage+'</h1></p><p><h1>Members:'+result.rows.item(0).members+'</h1></p><p><h1>Quantity: '+result.rows.item(0).quantity+'</h1></p><p><h1>Volume: '+result.rows.item(0).volume+'</h1></p><p><h1>Total Calories: '+result.rows.item(0).totalCalories+'</h1></p>';
